                      ...
                      <div className="mt-6 flex gap-3">
                        {cert.show_url && (
                          <a
                            ...
                            className={`cursor-target flex-1 flex items-center justify-center gap-2 px-4 py-2 rounded-xl border transition-all group-hover:border-violet-500/50 ${isDarkMode
